...
public class Promotion implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4726974972806854545L;
	@Id
	@GeneratedValue
	@Column(name = "C_ID")
	private Integer id;
	...
	public String getDescription() {
		if(description.contains(Constants.BOS_MANAGEMENT_HOST+"/bos_management")){
			return description;
		}
		return description.replace("/bos_management", Constants.BOS_MANAGEMENT_HOST+"/bos_management");
	}
