...
public class WayBill implements Serializable {
	...
	private static final long serialVersionUID = 4814511452526582619L;
	@Id
	@GeneratedValue
	@Column(name = "C_ID")
	@org.springframework.data.annotation.Id//因为有两个id注解不同的包要区分开-elasticsearch.
	@Field(index=FieldIndex.not_analyzed,//是否分词
	store=true,//是否保存
	type=FieldType.Integer)//保存的类型
	private Integer id;
